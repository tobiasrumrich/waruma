 ...
 * @author fabian
 * 
 * Diese Klasse stellt ein Spielerauto dar. Sie erweitert die Klasse StandardCar, indem sie ein Ziel beinhaltet und nach erfolgtem Move prüft, ob eben dieses Ziel erreicht wurde.
 * Darüber hinaus bietet sie Observern die Möglichkeit, sich zu registieren und informieren zu lassen, sobald das Spielerauto das Ziel erreicht hat.
 * 
 */
...
public class PlayerCar extends StandardCar implements IPlayer {
	...
	//führt den Move aus und fragt anschließend den CollisionDetector, ob das Ziel erreicht wurde. Bei positiver Rückmeldung werden die Observer informiert
	...
	// Ein Observer registriert sich beim Player, sodass dich beim Erreichen des Ziels den Observer benachrichtigt
