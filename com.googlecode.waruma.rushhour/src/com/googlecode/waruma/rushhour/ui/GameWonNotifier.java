...
public class GameWonNotifier extends Dialog {
	...
	public Object open() {
		...
		int newX =
				parentX
						+ ((parentWidth / 2) - (shlSpielGewonnen.getBounds().width / 2));
		int newY =
				parentY
						+ ((parentHeight / 2) - (shlSpielGewonnen.getBounds().height / 2));
	...
	private void createContents() {
		...
		shlSpielGewonnen.setBackground(SWTResourceManager
		...
		lblBild.setBackgroundImage(SWTResourceManager
				.getImage(
						GameWonNotifier.class,
						"/com/googlecode/waruma/rushhour/ui/images/" +
						"jean_victor_balin_tick_from_OpenClipArt_org.png"));
		...
		lblDuHastDas
				.setFont(SWTResourceManager.getFont("Tahoma", 17, SWT.BOLD));
		...
		lblBentigteZge.setFont(SWTResourceManager.getFont("Tahoma", 10,
				SWT.NORMAL));
		lblBentigteZge.setBackground(SWTResourceManager
				.getColor(SWT.COLOR_WHITE));
		...
		lblFrDieLsung.setFont(SWTResourceManager.getFont("Tahoma", 10,
				SWT.NORMAL));
		lblFrDieLsung.setBackground(SWTResourceManager
				.getColor(SWT.COLOR_WHITE));
